<template>
  <div class="mail-sent-down-key formed-wrap">
    <!-- 显示部分 -->
    <div class="formed-form"
      ...
      <div class="formed-form-item">
        <span>邮件文案：</span>
        <span class="mail-sent-down-key-writer"
              v-html="getWritter"></span>
      </div>
    </div>
    <!-- 编辑部分 -->
    <div class="formed-form mail-sent-down-key-form"
         v-else>
      <Form ref="formItem"
            :model="formItem"
            :rules="ruleValidate"
...
.mail-sent-down-key-writer {
  width: 330px;
  line-height: 1.5 !important;
  padding-top: 7px;
}
.mail-sent-down-key-form /deep/ .ivu-form-item-content {
  width: 366px;
}
