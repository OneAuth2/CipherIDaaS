 ...
 */
public class PageUserAuthzationDomain {
    private Integer currentPage;//当前页数
    private Integer prevPage;//上一页的页数
    private Integer nextPage;//下一页页数
    private List<UserInfoDomain> showUsers =new ArrayList<UserInfoDomain>();//用户内容
    ...
    public List<UserInfoDomain> getShowUsers() {
        return showUsers;
    }

    public void setShowUsers(List<UserInfoDomain> showUsers) {
