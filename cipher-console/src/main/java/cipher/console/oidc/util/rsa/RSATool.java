package cipher.console.oidc.util.rsa;
...
public class RSATool {
	...
	public static void main(String[] args) {
		...
		//私钥签名，公钥验签
		String s = generateSHA1withRSASigature(data, pri);
		System.err.println(s);
		boolean check = verifySHA1withRSASigature(s, data, pub);
		System.err.println(check);

	/*	//公钥加密，私钥解密
		String pubs = encryptWithPubKey(data, pub);
