...
public class AesUtil {
    ...
    public static void main(String[] args) {
     /*   String content = "SPIdIowMJ5XDnve0lFl1LwksmfZWL1LGCoOHqL5eoOI=";
        String password = "Ly123456";
        ...
        String s = "z3KFoFoRkxjnOJYNNns+kA==";
        AES.decryptFromBase64(s,SECRET_KEY);
        String userName=new String(AES.decryptFromBase64(s,SECRET_KEY));
        System.out.println("解密后的内容：" + new String(userName));
    }
