  ...
  methods: {
    ...
    pollingGetScanState () {
      ...
      this.axios({
        method: "post",
        data: params,
        url: apiLogin.daBaiSecondPolling
      })
        .then(response => {
          ...
          if (scanState === 0
            ...
            clearInterval(this.interval);
            let skipPath = skipPathUtil.fogetPWSkipNextPage(this.authLogic.forgetPwdFlow, 5);
