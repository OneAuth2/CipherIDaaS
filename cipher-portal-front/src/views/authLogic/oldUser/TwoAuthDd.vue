      ...
      this.axios({
        ...
        .then(response => {
          if (response.data.return_code === 0
            ...
            let skipPath = skipPathUtil.skipNextPage(this.authLogic.loginInfo, this.authLogic.secondLoginInfo, 2);
      ...
      this.axios({
        ...
        .then(response => {
          if (response.data.return_code === 0
            ...
            this.changeAuthLogic(this.authLogic);
            dingdingUtil.initGetDingding("/authLogic/oldUser/twoAuthDd", this.$store, dingTalkData);
          } else {
            console.error(response);
          }
        }).catch(function (error) {
