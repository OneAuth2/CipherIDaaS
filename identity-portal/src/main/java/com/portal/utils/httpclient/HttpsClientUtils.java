...
import com.portal.utils.SSLClient;
...
//            httpGet.addHeader("X-Requested-With", " XMLHttpRequest");
    ...
    public static Map<String, Object> doPostWithPayload(String url, String payload, String referer) {
        return doPostWithPayload(url, null, payload, null, null, referer, null);
    }
