...
public class VeDate {
    ...
    public static long getdiffTime(String str1,  String str2) throws ParseException {
    ...
    public static void main(String[] args) throws Exception {
        try {
            SimpleDateFormat dfs = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            Date begin=dfs.parse("2018-08-29 14:28:24");
            Date end = dfs.parse("2018-08-29 13:31:40");
            long between=(begin.getTime()-end.getTime())/1000;//除以1000是为了转换成秒
            long min=between/60;
